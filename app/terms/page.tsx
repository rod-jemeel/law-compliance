      ...
      <main className="flex-1 container py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p>
              Welcome to PermitTracker (&quot;we,&quot; &quot;our,&quot; or
              &quot;us&quot;). These Terms of Service (&quot;Terms&quot;) govern
              your access to and use of the PermitTracker website, mobile
            ...
            <p>
              PermitTracker offers various subscription plans. By selecting a
              subscription plan, you agree to pay the subscription fees
              indicated for that plan. Subscription fees are billed in advance
              on a monthly or annual basis, depending on the plan you select.
            </p>
            <p>
              You authorize us to charge the payment method you provide to us
              for all applicable fees. If your payment cannot be completed, we
              may suspend or terminate your access to the Service.
            </p>
            <p>
              All subscriptions automatically renew unless cancelled by you. You
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                Sell, resell, or commercially use the Service without our prior
                written consent
              </li>
            </ul>
            <h2 className="text-xl font-semibold mt-8 mb-4">
            ...
            <p>
              ...
              are and will remain the exclusive property of PermitTracker and
            ...
            <p>
              ...
              receive content (&quot;User Content&quot;). You retain ownership
              of any intellectual property rights that you hold in that User
              Content.
            </p>
            <p>
              By uploading, submitting, storing, sending, or receiving User
              Content to or through the Service, you grant us a worldwide,
              non-exclusive, royalty-free license to use, host, store,
              reproduce, modify, create derivative works, communicate, publish,
              publicly perform, publicly display, and distribute such User
              Content for the limited purpose of providing the Service to you.
            </p>
            <h2 className="text-xl font-semibold mt-8 mb-4">
            ...
            <p>
              ...
              PERMITTRACKER, ITS AFFILIATES, OFFICERS, DIRECTORS, EMPLOYEES, OR
            ...
            <p>
              ...
              LOSSES, OR CAUSES OF ACTION EXCEED THE AMOUNT YOU HAVE PAID US IN
            ...
            <p>
              You agree to defend, indemnify, and hold harmless PermitTracker,
            ...
            <p>
              Email: support@permittracker.com
              <br />
              Phone: (035) 422-8899
              <br />

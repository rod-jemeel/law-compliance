            ...
            <TabsContent value="official">
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      ...
                      the online eBPLS portal for business permit applications
                      and renewals.
                    </p>
                  </CardContent>
                  <CardFooter>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Register business names, access business resources, and
                      stay updated on trade and industry policies and programs.
                    </p>
                  </CardContent>
                  <CardFooter>
                    <Button variant="outline" className="w-full" asChild>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Register employers and employees, manage contributions,
                      and access SSS services and benefits information.
                    </p>
                  </CardContent>
                  <CardFooter>
                    <Button variant="outline" className="w-full" asChild>
            ...
            <TabsContent value="guides">
              <div className="grid gap-6 md:grid-cols-2">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      ...
                      new business in Dumaguete City, from national
                      registrations to local permits.
                    </p>
                  </CardContent>
                  <CardFooter>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Collection of video tutorials demonstrating how to
                      navigate the eBPLS portal, complete forms correctly, and
                ...
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <div className="flex items-start gap-2">
                      <MapPin className="h-4 w-4 text-muted-foreground mt-0.5" />
                      <p className="text-sm">
                        2nd Floor, NEDA Building, EJ Blanco Drive, Dumaguete
                        City
                      </p>
                    </div>
                    <div className="flex items-start gap-2">

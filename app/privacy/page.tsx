        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p>
              ...
              individually. We may collect the following personal information:
            </p>
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                Business information (such as business name, type, registration
                numbers, and permit details)
              </li>
              <li>
                Profile information (such as profile picture and user
                preferences)
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                Usage patterns (such as features used, time spent on the
                Service, and click-through data)
              </li>
              <li>Location data (if you enable this functionality)</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-4">
              <li>
                Direct collection when you provide information to us (such as
              ...
              <li>
                Third-party sources (such as business partners, analytics
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                Sending you notifications, updates, and promotional materials
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                ...
                property, or safety of PermitTracker, our users, or others
              </li>
            </ul>
